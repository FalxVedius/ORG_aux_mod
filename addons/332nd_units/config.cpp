...
class Extended_Fired_EventHandlers
{
	...
	class MACRO_NEW_UNIT(cisb1,base)
	{
		Aux332nd_FiredSound = "_rndNum = floor(random 8); if( _rndNum == 0 ) then { [_this select 0, _this select 1, _this select 2, _this select 3, _this select 4, _this select 5, _this select 6, _this select 7] call Aux332nd_fnc_Fired; };";
	};
	class MACRO_NEW_UNIT(cisb1jumppack,base)
	{
		Aux332nd_FiredSound = "_rndNum = floor(random 8); if( _rndNum == 0 ) then { [_this select 0, _this select 1, _this select 2, _this select 3, _this select 4, _this select 5, _this select 6, _this select 7] call Aux332nd_fnc_Fired; };";
	...
	class MACRO_NEW_UNIT(cisbx,base)
	{
		Aux332nd_FiredSound = "_rndNum = floor(random 8); if( _rndNum == 0 ) then { [_this select 0, _this select 1, _this select 2, _this select 3, _this select 4, _this select 5, _this select 6, _this select 7] call Aux332nd_fnc_Fired_BX; };";
	};
	class MACRO_NEW_UNIT(cisbxcapt,base)
	{
		Aux332nd_FiredSound = "_rndNum = floor(random 8); if( _rndNum == 0 ) then { [_this select 0, _this select 1, _this select 2, _this select 3, _this select 4, _this select 5, _this select 6, _this select 7] call Aux332nd_fnc_Fired_BX; };";

	...
	switch (true) do {
		...
		{ 
			...
			switch (true) do {
				...
				case (_rndSound == 0): 
				{
					[_obj,["BX_ThrowingGrenade_1_332nd", 200, 1]] remoteExec ["say3D",0,true];
				};
				case (_rndSound == 1): 
				{
					[_obj,["BX_ThrowingGrenade_2_332nd", 200, 1]] remoteExec ["say3D",0,true];
				};
				case (_rndSound == 2): 
				{
					[_obj,["BX_ThrowingGrenade_3_332nd", 200, 1]] remoteExec ["say3D",0,true];
				};
			
				default { [_obj,["BX_ThrowingGrenade_1_332nd", 200, 1]] remoteExec ["say3D",0,true]; };
			};
	};

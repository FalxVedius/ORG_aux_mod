...
class cfgSoundShaders 
{
	...
	{
		samples[] = {{"332nd_weapons\DC\17m\sounds\DC15sClose.wss",1}}; 
		volume = 0.4466836; 
		range = 5;
	};
	...
	{
		samples[] = {{"332nd_weapons\DC\17m\sounds\DC15sDistant.wss",1}};
		volume = 0.7943282;
		range = 1800;
	...
	{
		samples[] = {{"332nd_weapons\DC\17m\sounds\DC15sFar.wss",1}};
		volume = 1.0;
		range = 4000;

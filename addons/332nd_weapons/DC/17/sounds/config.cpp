...
{
	//###################################### SHOTS ######################################
	class 332_DC17_Closure_SoundShader
	{
	...
	class 332_DC17_midShot_SoundShader
	{
		samples[] = {{"332nd_weapons\DC\17\Sounds\DC17Distant.wss",1}};
		volume = 0.7943282;
		range = 1800;
		rangeCurve[] = {{0,0.2},{50,1},{300,0},{1800,0}};
	};
	class 332_DC17_distShot_SoundShader
	{
		samples[] = {{"332nd_weapons\DC\17\Sounds\DC17Far.wss",1}};
		volume = 1.0;
		range = 4000;

...
class CfgPatches
{
	class MACRO_PATCH_NAME(R_Shotguns)
	{
...
class CfgMagazines
{
	...
	class MACRO_NEW_MAG(R_DP23,12): 30rnd_762x39_AK12_Mag_F //DP-23
	{
		scope=2;
...
class CfgAmmo
{
	...
	class MACRO_NEW_AMMO(R_DP23_Shell): B_12Gauge_Pellets_Submunition
	{
		submunitionAmmo = MACRO_NEW_AMMO(R_DP23_Pellet);

...
class CfgVehicles
{
	...
	{
		  displayName = "Hornet CAP Droid (Experimental)";
		  scope = 2;
		  side = 2;
		  scopeCurator = 2;
	...
	{
		  displayName = "Hornet CAS Droid (Experimental)";
		  scope = 2;
			side = 2;
		  scope = 2;
		  armor = 25;
	...
	class MACRO_NEW_VEHICLE(air,CIS,Rebel_Vulture_GUN) : 3AS_Vulture_Base_F
	{

...
class CfgPatches
{
	class MACRO_PATCH_NAME(Nu_Shuttle)
	{
		...
		requiredVersion = 0.1;
		units[] = {
            MACRO_NEW_VEHICLE(air,Nu,Rebel_attack_Shuttle_base)
        };
		weapons[] = {};
	};
};
...
{
	class MACRO_NEW_VEHICLE(air,Nu,Rebel_attack_Shuttle_base)
	{
		class laat_init_eh
		{
...
class CfgVehicles
{
	...
	class MACRO_NEW_VEHICLE(air,Nu,Rebel_attack_Shuttle_base): B_Heli_Attack_01_base_F
	{
		author="Halligan";
		_generalMacro="";
		scope=2;

...
{
	class 332_Suppressed_DC15k_SoundShader
	{
	...
	class 332_Suppressed_DC15k_distShot_SoundShader
	{
...
class cfgSoundSets //on more info about soundSets look at the [[Arma_3_Sound:_cfgSoundSets|relevant wiki page]]
{
	...
	class 332_Suppresed_DC15k_Shot_SoundSet
	{
		soundShaders[] = {"332_Suppressed_DC15k_SoundShader","332_Suppressed_DC15k_distShot_SoundShader","332_DC15a_tailInterior_SoundShader"};
		volumeFactor = 1;

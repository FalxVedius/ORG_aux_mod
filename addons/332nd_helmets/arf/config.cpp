...
class CfgWeapons
{
	...
	MACRO_NEW_ARF_HELMET_ITEM(332nd_recon_woodland,Recon (Multi-cam),Trooper_Woodland.paa)
	...
	MACRO_NEW_ARF_HELMET_ITEM(332nd_recon_veteran_woodland,Veteran Recon (Multi-cam),Vet_Woodland.paa)
	...
	MACRO_NEW_ARF_HELMET_ITEM(332nd_recon_Spec_woodland,Specialist Recon(Multi-cam),Spec_Woodland.paa)
	...
	MACRO_NEW_ARF_HELMET_ITEM(332nd_recon_Corp_woodland,Corporal Recon(Multi-cam),CP_Woodland.paa)
	...
	MACRO_NEW_ARF_HELMET_ITEM(332nd_recon_Serg_woodland,Sergeant Recon(Multi-cam),CS_Woodland.paa)
	...
	MACRO_NEW_ARF_CUSTOM_HELMET_ITEM(Moca_Wood,Moca Multi-cam,Moca_Wood.paa)
	...
	MACRO_NEW_ARF_HELMET_ITEM(Fuzzy,Fuzzy,Fuzzy.paa)
	MACRO_NEW_ARF_CUSTOM_HELMET_ITEM(Fuzzy_Wood,Fuzzy Multi-cam,Fuzzy_Wood.paa)
	MACRO_NEW_ARF_CUSTOM_HELMET_ITEM(Fuzzy_Des,Fuzzy Desert,Fuzzy_Des.paa)
